      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <h3 className="text-xl font-bold text-vinho dark:text-dourado">ContaAi</h3>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-vinho dark:text-dourado mb-4">Recursos</h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="/calculadora"
                  className="text-slate-600 dark:text-slate-300 hover:text-vinho dark:hover:text-dourado text-sm"
                >
                  Calculadora de ICMS
                </a>
              </li>
          ...
          <div>
            <h4 className="font-semibold text-vinho dark:text-dourado mb-4">Suporte</h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
          ...
          <div>
            <h4 className="font-semibold text-vinho dark:text-dourado mb-4">Legal</h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-600 dark:text-slate-300 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} ContaAi - Todos os direitos reservados
          </p>
