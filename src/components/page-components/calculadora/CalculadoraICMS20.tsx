...
import { calcularBaseIcmsReduzida, calcularIcms20 } from "@/utils/calculadoraICMS"
...
const CalculadoraICMS20: React.FC<CalculadoraProps> = ({ storageDisponivel }) => {
  ...
  const calcular = () => {
    ...
    const valorIcms = calcularIcms20(
      valores.valorProduto,
      valores.valorFrete,
      valores.valorSeguro,
      valores.valorOutro,
    ...
    setResultado({ baseIcmsReduzida, valorIcms })
  }
  ...
  const salvar = () => {
    ...
    try {
      ...
      const novoCalculo = salvarCalculo({
        ...
        valorBase: resultado.baseIcmsReduzida,
        aliquota: valores.aliquotaIcms,
        resultado: resultado.valorIcms,
        detalhes: {
          ...valores,
          baseIcmsReduzida: resultado.baseIcmsReduzida,
            ...
            <div className="mt-8 p-6 bg-bg-light/50 dark:bg-bg-darker/50 backdrop-blur-sm rounded-xl border border-bg-medium/30 dark:border-bg-dark/50 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-bg-darker p-5 rounded-xl border border-bg-medium/30 dark:border-bg-dark/50 shadow-sm hover:shadow-md transition-shadow">
                  <p className="text-sm text-txt-secondary dark:text-txt-muted">Base de Cálculo Reduzida:</p>
                  <p className="font-medium text-xl text-txt-primary dark:text-txt-light mt-1">
                    {formatCurrency(resultado.baseIcmsReduzida)}
                  </p>
                </div>
...
export default CalculadoraICMS20
