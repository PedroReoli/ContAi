...
const CalculadoraICMS70: React.FC<CalculadoraProps> = ({ storageDisponivel }) => {
  ...
  const calcular = () => {
    const valores = {
      ...
      percentualReducao: parseNumberBR(formData.percentualReducao || "0"),
      percentualReducaoST: parseNumberBR(formData.percentualReducaoST || "0"),
    ...
    const valorIcmsST = calcularIcms70(
      valores.valorProduto,
      valores.valorFrete,
      valores.valorSeguro,
      valores.valorOutro,
      ...
      {showPdfPreview && calculoSalvo ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Input
              label="Percentual de Redução Base Própria (%)"
              name="percentualReducao"
              value={formData.percentualReducao}
              onChange={handleChange}
              placeholder="0,00"
              className="bg-white dark:bg-bg-darker border-bg-medium/30 dark:border-bg-dark/50 rounded-xl p-4 focus-within:ring-2 focus-within:ring-primary/30 dark:focus-within:ring-secondary/30 transition-all"
            />
            ...
            <Input
              label="Percentual de Redução Base ST (%)"
              name="percentualReducaoST"
              value={formData.percentualReducaoST}
              onChange={handleChange}
              placeholder="0,00"
              className="bg-white dark:bg-bg-darker border-bg-medium/30 dark:border-bg-dark/50 rounded-xl p-4 focus-within:ring-2 focus-within:ring-primary/30 dark:focus-within:ring-secondary/30 transition-all"
            />
            ...
            <div className="mt-8 p-6 bg-bg-light/50 dark:bg-bg-darker/50 backdrop-blur-sm rounded-xl border border-bg-medium/30 dark:border-bg-dark/50 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white dark:bg-bg-darker p-5 rounded-xl border border-bg-medium/30 dark:border-bg-dark/50 shadow-sm hover:shadow-md transition-shadow">
                  <p className="text-sm text-txt-secondary dark:text-txt-muted">Base de Cálculo do ICMS Próprio:</p>
                ...
                <div className="bg-white dark:bg-bg-darker p-5 rounded-xl border border-bg-medium/30 dark:border-bg-dark/50 shadow-sm hover:shadow-md transition-shadow">
                  <p className="text-sm text-txt-secondary dark:text-txt-muted">Valor do ICMS Próprio:</p>
                  <p className="font-medium text-xl text-txt-primary dark:text-txt-light mt-1">
                ...
                <div className="bg-white dark:bg-bg-darker p-5 rounded-xl border border-bg-medium/30 dark:border-bg-dark/50 shadow-sm hover:shadow-md transition-shadow">
                  <p className="text-sm text-txt-secondary dark:text-txt-muted">Base de Cálculo do ICMS ST:</p>
                  <p className="font-medium text-xl text-txt-primary dark:text-txt-light mt-1">
                ...
                <div className="relative overflow-hidden bg-white dark:bg-bg-darker p-5 rounded-xl border-2 border-primary/20 dark:border-secondary/20 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-txt-secondary dark:text-txt-muted">Valor do ICMS ST:</p>
...
export default CalculadoraICMS70
