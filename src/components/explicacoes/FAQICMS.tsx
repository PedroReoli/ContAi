      ...
      answer: (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="p-4 rounded-lg bg-bg-medium/30 dark:bg-bg-dark/30 border border-bg-medium/30 dark:border-bg-dark/50">
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <div className="p-5 rounded-xl bg-bg-medium/30 dark:bg-bg-dark/30 border border-bg-medium/30 dark:border-bg-dark/50 mt-4">
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <div className="p-4 rounded-lg bg-bg-medium/30 dark:bg-bg-dark/30 border border-bg-medium/30 dark:border-bg-dark/50 mt-2">
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <div className="p-4 rounded-lg bg-bg-medium/30 dark:bg-bg-dark/30 border border-bg-medium/30 dark:border-bg-dark/50 mt-4">
        ...
        <Card className="overflow-hidden border-0 shadow-xl bg-white/90 dark:bg-bg-darker/90 backdrop-blur-sm">
          ...
          <CardHeader className="bg-bg-medium/30 dark:bg-bg-dark/30 p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <CardTitle className="text-3xl text-primary dark:text-secondary">Perguntas Frequentes</CardTitle>
            ...
            <div className="space-y-4">
              {faqItems.map((item, index) => (
                <motion.div
                  ...
                  className="border-b border-bg-medium/30 dark:border-bg-dark/50 last:border-b-0"
                >
                  <div
